  ...
  return (
    ...
    >
      <div className="container">
        <div className="intro">
          <img src="images/profile-picture.png" alt="Brendon" className="mb-4" />

          <h1 className="mb-2 mt-0">Brendon Chiang</h1>
          <p>
            I'm a{" "}
            <Typed
              strings={[
                ...
                "fool for graduating during a pandemic"
              ]}
              typeSpeed={80}
              backSpeed={40}
              attr="value"
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://www.instagram.com/brendonchiang/">
                <i className="fab fa-instagram"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://ca.linkedin.com/in/brendon-chiang">
                <i class="fab fa-linkedin-in"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://www.github.com/brendon-chiang">
